...
INSERT INTO public.elements VALUES (1, 'H', 'Hydrogen', '1');
INSERT INTO public.elements VALUES (2, 'He', 'Helium', '2');
INSERT INTO public.elements VALUES (3, 'Li', 'Lithium', '3');
INSERT INTO public.elements VALUES (4, 'Be', 'Beryllium', '4');
INSERT INTO public.elements VALUES (5, 'B', 'Boron', '5');
INSERT INTO public.elements VALUES (6, 'C', 'Carbon', '6');
INSERT INTO public.elements VALUES (7, 'N', 'Nitrogen', '7');
INSERT INTO public.elements VALUES (8, 'O', 'Oxygen', '8');
INSERT INTO public.elements VALUES (9, 'F', 'Fluorine', '9');
INSERT INTO public.elements VALUES (10, 'Ne', 'Neon', '10');
...
INSERT INTO public.properties VALUES (1, 1.008, -259.1, -252.9, 2, '1');
INSERT INTO public.properties VALUES (2, 4.0026, -272.2, -269, 2, '2');
INSERT INTO public.properties VALUES (3, 6.94, 180.54, 1342, 1, '3');
INSERT INTO public.properties VALUES (4, 9.0122, 1287, 2470, 1, '4');
INSERT INTO public.properties VALUES (5, 10.81, 2075, 4000, 3, '5');
INSERT INTO public.properties VALUES (6, 12.011, 3550, 4027, 2, '6');
INSERT INTO public.properties VALUES (7, 14.007, -210.1, -195.8, 2, '7');
INSERT INTO public.properties VALUES (8, 15.999, -218, -183, 2, '8');
INSERT INTO public.properties VALUES (9, 18.998, -220, -188.1, 2, '9');
INSERT INTO public.properties VALUES (10, 20.18, -248.6, -246.1, 2, '10');
...
ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_elements FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number) ON DELETE CASCADE;


--
-- Name: elements fk_properties; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT fk_properties FOREIGN KEY (atomic_number) REFERENCES public.properties(atomic_number) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_types FOREIGN KEY (type_id) REFERENCES public.types(type_id) ON DELETE CASCADE;
