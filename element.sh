...
SYM_SYMBOL=$($PSQL "SELECT symbol FROM elements FULL JOIN properties ON elements.atomic_number = properties.atomic_number WHERE elements.ref='$SYM_NUM'")

SYM_NAME=$($PSQL "SELECT name FROM elements FULL JOIN properties ON elements.atomic_number = properties.atomic_number WHERE elements.ref='$SYM_NUM'")
